...
public:
    HopDong();
    HopDong(const string&, const string&, const string&, bool = true, HoiVien* = nullptr, GoiTap* = nullptr, NhanVien* = nullptr);
    ...
    static HopDong* create(const string&, const string&, const string&, bool = true, HoiVien* = nullptr, GoiTap* = nullptr, NhanVien* = nullptr);
    static HopDong* create(const string&, const string&, bool = true, HoiVien* = nullptr, GoiTap* = nullptr, NhanVien* = nullptr);
    string read();
};
