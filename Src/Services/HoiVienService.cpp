                                 ...
                                 const string &gioiTinh, const string &ngaySinh, int point)
{
    ...
    {
        ql.setDirty(true);
        SearchService::indexHoiVien(newHoiVien);
                                ...
                                const string &gioiTinh, const string &ngaySinh, int point)
{
    ...
    if (hvCanSua->getHoTen() != tenHV)
    {
        SearchService::removeIndexHoiVien(hvCanSua);
        hvCanSua->setHoTen(tenHV);
        SearchService::indexHoiVien(hvCanSua);
    }
    else
    {
        hvCanSua->setHoTen(tenHV);
...
void HoiVienService::xoaHoiVien(const string &maHV)
{
    ...
    SearchService::removeIndexHoiVien(hvCanXoa);
